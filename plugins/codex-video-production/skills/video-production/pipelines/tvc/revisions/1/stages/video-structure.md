...
Read `brief.md`, `proposals/selected.json` and the selected proposal file. Preserve the confirmed duration, ratio, product claims, mandatory elements and restrictions.
...
Do not generate media, create Provider requests, or replace the selected concept.
