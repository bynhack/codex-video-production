...
Identify only consequential gaps: product and promise, audience, objective/CTA, market/language, platform, exact duration, aspect ratio, mandatory elements, restrictions, audio policy and use of supplied assets. Prefer compact multiple-choice questions with an optional free-text escape. Present them in one Preview form when possible. State assumptions rather than blocking on nonessential detail.
